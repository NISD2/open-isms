...
export async function generateMetadata({
  ...
  const title = t("amIDataCentre.meta.title");
  const description = t("amIDataCentre.meta.description");
  return {
    title,
    description,
    alternates: pageAlternates(
      "wiki/anwendungsbereich/bin-ich-rechenzentrum-nis2",
      locale,
    ),
    ...pageOg({
      slug: "wiki/anwendungsbereich/bin-ich-rechenzentrum-nis2",
      locale,
      title,
      description,
      type: "article",
      ...
      <div className="space-y-10">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("amIDataCentre.elements.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("amIDataCentre.principles.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("amIDataCentre.pitfalls.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("amIDataCentre.platform.heading")}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("amIDataCentre.platform.p1")}
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("amIDataCentre.platform.p2")}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2">
              {(t.raw("amIDataCentre.sources.items") as string[]).map(
                (source, i) => (
                  <li
                    key={i}
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("amIDataCentre.ctaCard.heading")}</CardTitle>
            <CardDescription>
              {t("amIDataCentre.ctaCard.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
              <Link href="/auth/signin">{t("amIDataCentre.cta")}</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
