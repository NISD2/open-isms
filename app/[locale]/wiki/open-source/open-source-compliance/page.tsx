...
const NS = "openSourceCompliance";
const SLUG = "open-source-compliance";
const sectionKeys = ["transparency", "supplierRisk", "manyEyes"] as const;
    ...
    <GlossedProse locale={locale}>
      <div className="space-y-10">
        <WikiPageJsonLd
          ...
          audienceType="CISO, Auditor, Compliance-Verantwortliche"
        ...
        <WikiPageMeta authorSlug="cory-hisey" locale={locale} />
