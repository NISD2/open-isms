...
export async function generateMetadata({
  ...
  const title = t("nis2StatusDaenemark.meta.title");
  const description = t("nis2StatusDaenemark.meta.description");
  return {
    title,
    description,
...
const nationalKeys = ["cfcs", "sectoral", "enisa"] as const;
const pitfallKeys = ["sameAsGermany", "noRegistry", "onlySector"] as const;

export default async function Nis2StatusDaenemarkPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
      ...
      <div className="space-y-10">
        ...
        <header>
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            {t("nis2StatusDaenemark.title")}
          </h1>
          <p className="mt-2 text-lg text-muted-foreground">
            {t("nis2StatusDaenemark.subtitle")}
          </p>
        </header>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("nis2StatusDaenemark.sources.heading")}</CardTitle>
          </CardHeader>
          <CardContent>
