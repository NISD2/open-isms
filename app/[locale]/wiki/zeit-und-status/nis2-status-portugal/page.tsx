...
export async function generateMetadata({
  ...
  const title = t("nis2StatusPortugal.meta.title");
  const description = t("nis2StatusPortugal.meta.description");
  return {
    title,
    description,
...
const nationalKeys = ["cncs", "certPt", "enisa"] as const;
const pitfallKeys = ["sameAsGermany", "noRegistry", "onlySector"] as const;

export default async function Nis2StatusPortugalPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
      ...
      <div className="space-y-10">
        ...
        <header>
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            {t("nis2StatusPortugal.title")}
          </h1>
          <p className="mt-2 text-lg text-muted-foreground">
            {t("nis2StatusPortugal.subtitle")}
          </p>
        </header>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("nis2StatusPortugal.sources.heading")}</CardTitle>
          </CardHeader>
          <CardContent>
