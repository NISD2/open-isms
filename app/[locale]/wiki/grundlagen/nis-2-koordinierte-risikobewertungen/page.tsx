...
export async function generateMetadata({
  ...
  const title = t("coordinatedRiskAssessments.meta.title");
  const description = t("coordinatedRiskAssessments.meta.description");
  return {
    title,
    description,
    alternates: pageAlternates(
      "wiki/grundlagen/nis-2-koordinierte-risikobewertungen",
      locale,
    ),
    ...pageOg({
      slug: "wiki/grundlagen/nis-2-koordinierte-risikobewertungen",
      locale,
      title,
      description,
      type: "article",
...
const pitfallKeys = ["only5g", "belowThreshold", "enforcement"] as const;

export default async function CoordinatedRiskAssessmentsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <GlossedProse locale={locale}>
      <div className="space-y-10">
        <WikiPageJsonLd
          category="grundlagen"
          slug="nis-2-koordinierte-risikobewertungen"
          locale={locale}
        ...
        <header>
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            {t("coordinatedRiskAssessments.title")}
          </h1>
          <p className="mt-2 text-lg text-muted-foreground">
            {t("coordinatedRiskAssessments.subtitle")}
          </p>
        </header>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold tracking-tight">
            {t("coordinatedRiskAssessments.overview.heading")}
          </h2>
          <p className="text-sm leading-relaxed text-muted-foreground">
            {t("coordinatedRiskAssessments.overview.p1")}
          </p>
          <p className="text-sm leading-relaxed text-muted-foreground">
            {t("coordinatedRiskAssessments.overview.p2")}
          </p>
          <p className="text-sm leading-relaxed text-muted-foreground">
            {t("coordinatedRiskAssessments.overview.p3")}
          </p>
        </section>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("coordinatedRiskAssessments.practitioner.p1")}
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("coordinatedRiskAssessments.practitioner.p2")}
            </p>
          </CardContent>
        </Card>
