...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: pageAlternates(
      "wiki/troubleshooting/bsi-anfrage-erhalten",
      locale,
    ),
    ...pageOg({
    ...
    <GlossedProse locale={locale}>
      <div className="space-y-10">
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t("bsiAnfrageErhalten.practitioner.heading")}
            </CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("bsiAnfrageErhalten.platform.heading")}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("bsiAnfrageErhalten.platform.p1")}
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              {t("bsiAnfrageErhalten.platform.p2")}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2">
              {(t.raw("bsiAnfrageErhalten.sources.items") as string[]).map(
                (source, i) => (
                  <li
                    key={i}
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("bsiAnfrageErhalten.ctaCard.heading")}</CardTitle>
            <CardDescription>
              {t("bsiAnfrageErhalten.ctaCard.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
              <Link href="/applicability">{t("bsiAnfrageErhalten.cta")}</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
