    ...
    <>
      <article>
        <header className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground">{t("datenschutz.subtitle")}</p>
        </header>
          ...
          <Card>
            ...
            <CardContent className="space-y-1 text-sm text-muted-foreground">
              ...
              <p className="mt-3 font-medium text-foreground">
                {t("datenschutz.responsible.company")}
              </p>
              <p>{t("datenschutz.responsible.address")}</p>
              <p>
                {t("datenschutz.responsible.emailLabel")}:{" "}
                {t("datenschutz.responsible.email")}
              </p>
            </CardContent>
          </Card>
        </section>
