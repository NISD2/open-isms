      ...
      <main className="relative min-h-screen overflow-x-clip px-6 pb-24 pt-20 sm:pt-24">
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-[minmax(0,25rem)_1fr] lg:items-center">
            ...
            >
              {/* Per-locale product shot, generated by the NIS2 private tool.
                  There is no fallback: this is a bare src, so a locale with no
                  file is a broken image. Every locale in i18n/routing.ts has
                  one; adding an eleventh means generating its shot too. */}
              {/* biome-ignore lint/performance/noImgElement: locale-templated src, one file per locale, no optimisation wanted */}
              <img
                src={`/images/hero/journey-${locale}.png`}
