  ...
  questions: [
    {
      ...
      explanation: {
        ...
        cs: "'Dodavatel' podle NIS2 znamená kohokoli s přístupem k vašim systémům nebo datům: od poskytovatelů cloudu po úklidovou firmu s klíčem od serverovny.",
        pt: "'Fornecedor' ao abrigo da NIS2 significa qualquer pessoa com acesso aos seus sistemas ou dados: desde fornecedores de nuvem até à empresa de limpeza com uma chave da sala de servidores.",
        ro: "'Furnizor' în temeiul NIS2 înseamnă oricine are acces la sistemele sau datele dumneavoastră: de la furnizorii de cloud până la firma de curățenie care deține o cheie a camerei serverelor.",
      },
    },
    {
      id: "2.9.2",
      question: {
        ...
        cs: "Které čtyři věci CIR u každého dodavatele očekává?",
        pt: "Quais são as quatro coisas que o CIR espera para cada fornecedor?",
        ro: "Care sunt cele patru lucruri pe care CIR le așteaptă pentru fiecare furnizor?",
      },
      options: [
        { en: "Contract, payment, delivery, warranty", de: "Vertrag, Zahlung, Lieferung, Garantie", nl: "Contract, betaling, levering, garantie", fr: "Contrat, paiement, livraison, garantie", it: "Contratto, pagamento, consegna, garanzia", es: "Contrato, pago, entrega, garantía", pl: "Umowa, płatność, dostawa, gwarancja", cs: "Smlouva, platba, dodání, záruka", pt: "Contrato, pagamento, entrega, garantia", ro: "Contract, plată, livrare, garanție" },
        { en: "Inventory entry, risk classification, contractual security clauses, and periodic review", de: "Inventareintrag, Risikoklassifizierung, vertragliche Sicherheitsklauseln und regelmäßige Überprüfung", nl: "Inventarisatie, risicoklassificatie, contractuele beveiligingsclausules en periodieke beoordeling", fr: "Inscription à l'inventaire, classification du risque, clauses de sécurité contractuelles et réexamen périodique", it: "Iscrizione all'inventario, classificazione del rischio, clausole contrattuali di sicurezza e riesame periodico", es: "Entrada en el inventario, clasificación del riesgo, cláusulas contractuales de seguridad y revisión periódica", pl: "Wpis do inwentaryzacji, klasyfikacja ryzyka, umowne klauzule bezpieczeństwa oraz okresowy przegląd", cs: "Záznam v inventáři, klasifikace rizik, smluvní bezpečnostní ujednání a pravidelný přezkum", pt: "Entrada no inventário, classificação de risco, cláusulas contratuais de segurança e revisão periódica", ro: "Înregistrare în inventar, clasificarea riscului, clauze contractuale de securitate și revizuire periodică" },
        { en: "NDA, insurance certificate, audit report, reference check", de: "NDA, Versicherungsnachweis, Audit-Bericht, Referenzprüfung", nl: "NDA, verzekeringscertificaat, auditrapport, referentiecheck", fr: "NDA, certificat d'assurance, rapport d'audit, vérification des références", it: "NDA, certificato assicurativo, rapporto di audit, verifica delle referenze", es: "NDA, certificado de seguro, informe de auditoría, verificación de referencias", pl: "NDA, certyfikat ubezpieczeniowy, raport z audytu, sprawdzenie referencji", cs: "Dohoda o mlčenlivosti, pojistné osvědčení, zpráva z auditu, ověření referencí", pt: "Acordo de confidencialidade, certificado de seguro, relatório de auditoria, verificação de referências", ro: "Acord de confidențialitate, certificat de asigurare, raport de audit, verificarea referințelor" },
        { en: "Background check, credit check, compliance score, annual fee", de: "Hintergrundprüfung, Bonitätsprüfung, Compliance-Bewertung, Jahresgebühr", nl: "Antecedentenonderzoek, kredietcheck, compliancescore, jaarlijkse vergoeding", fr: "Enquête de moralité, vérification de solvabilité, score de conformité, frais annuels", it: "Controllo dei precedenti, verifica del credito, punteggio di conformità, canone annuale", es: "Verificación de antecedentes, comprobación de solvencia, puntuación de cumplimiento, cuota anual", pl: "Sprawdzenie przeszłości, sprawdzenie zdolności kredytowej, wynik zgodności, roczna opłata", cs: "Prověření minulosti, kontrola bonity, skóre dodržování předpisů, roční poplatek", pt: "Verificação de antecedentes, avaliação de crédito, pontuação de conformidade, taxa anual", ro: "Verificarea antecedentelor, verificarea bonității, scor de conformitate, taxă anuală" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Čtyři požadavky jsou: inventář dodavatelů, klasifikace rizik, smluvní ujednání (oznamování, práva na audit, základní úroveň) a pravidelný přezkum.",
        pt: "Os quatro requisitos são: inventário de fornecedores, classificação de risco, cláusulas contratuais (notificação, direitos de auditoria, requisitos mínimos) e revisão periódica.",
        ro: "Cele patru cerințe sunt: inventarul furnizorilor, clasificarea riscului, clauze contractuale (notificare, drepturi de audit, cerințe minime) și revizuire periodică.",
      },
    },
    {
      id: "2.9.3",
      question: {
        ...
        cs: "Pokud je váš dodavatel napaden a data vašich zákazníků jsou vystavena, kdo nese ohlašovací povinnost?",
        pt: "Se o seu fornecedor sofrer uma violação e os dados dos seus clientes ficarem expostos, quem suporta o dever de notificação?",
        ro: "Dacă furnizorul dumneavoastră suferă o breșă, iar datele clienților dumneavoastră sunt expuse, cine suportă obligația de raportare?",
      },
      options: [
        { en: "The supplier, because the breach happened in their systems", de: "Der Lieferant, weil der Vorfall in seinen Systemen geschah", nl: "De leverancier, omdat het incident in hun systemen plaatsvond", fr: "Le fournisseur, parce que la violation s'est produite dans ses systèmes", it: "Il fornitore, perché la violazione è avvenuta nei suoi sistemi", es: "El proveedor, porque la brecha se produjo en sus sistemas", pl: "Dostawca, ponieważ naruszenie nastąpiło w jego systemach", cs: "Dodavatel, protože k narušení došlo v jeho systémech", pt: "O fornecedor, porque a violação ocorreu nos seus sistemas", ro: "Furnizorul, deoarece breșa a survenit în sistemele sale" },
        { en: "You, because the reporting and notification duties under Articles 23 and 36 land on the entity, not the supplier", de: "Sie, weil die Melde- und Benachrichtigungspflichten gemäß Artikel 23 und 36 bei der Einrichtung liegen, nicht beim Lieferanten", nl: "U, omdat de meldings- en kennisgevingsplichten uit Artikelen 23 en 36 bij de entiteit liggen, niet bij de leverancier", fr: "Vous, parce que les obligations de signalement et de notification au titre des articles 23 et 36 incombent à l'entité, et non au fournisseur", it: "Voi, perché gli obblighi di segnalazione e notifica ai sensi degli articoli 23 e 36 spettano al soggetto, non al fornitore", es: "Usted, porque los deberes de notificación de los artículos 23 y 36 recaen en la entidad, no en el proveedor", pl: "Państwo, ponieważ obowiązki zgłaszania i powiadamiania na podstawie artykułów 23 i 36 spoczywają na podmiocie, a nie na dostawcy", cs: "Vy, protože ohlašovací a oznamovací povinnosti podle článků 23 a 36 dopadají na subjekt, nikoli na dodavatele", pt: "O senhor, porque os deveres de notificação ao abrigo dos artigos 23 e 36 recaem sobre a entidade, e não sobre o fornecedor", ro: "Dumneavoastră, deoarece obligațiile de raportare și de notificare prevăzute la articolele 23 și 36 revin entității, nu furnizorului" },
        { en: "The customers themselves, because they own the data", de: "Die Kunden selbst, weil ihnen die Daten gehören", nl: "De klanten zelf, omdat zij eigenaar zijn van de gegevens", fr: "Les clients eux-mêmes, parce qu'ils sont propriétaires des données", it: "I clienti stessi, perché sono proprietari dei dati", es: "Los propios clientes, porque son los propietarios de los datos", pl: "Sami klienci, ponieważ są właścicielami danych", cs: "Sami zákazníci, protože data vlastní oni", pt: "Os próprios clientes, porque são os proprietários dos dados", ro: "Clienții înșiși, deoarece ei sunt proprietarii datelor" },
        { en: "The national regulator, because they manage all reporting", de: "Die nationale Aufsichtsbehörde, weil sie alle Meldungen verwaltet", nl: "De nationale toezichthouder, omdat die alle meldingen beheert", fr: "L'autorité de contrôle nationale, parce qu'elle gère tous les signalements", it: "L'autorità di vigilanza nazionale, perché gestisce tutte le segnalazioni", es: "La autoridad reguladora nacional, porque gestiona todas las notificaciones", pl: "Krajowy organ nadzoru, ponieważ zarządza wszystkimi zgłoszeniami", cs: "Vnitrostátní regulační orgán, protože spravuje veškeré ohlašování", pt: "A autoridade reguladora nacional, porque gere todas as notificações", ro: "Autoritatea națională de reglementare, deoarece gestionează toate raportările" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Ohlašovací povinnost podle článku 23 i oznamovací povinnost vůči zákazníkům podle článku 36 dopadají na vás. Hlášení dodavatele vás nekryje.",
        pt: "O dever de notificação ao abrigo do artigo 23 e o dever de notificação aos clientes ao abrigo do artigo 36 recaem ambos sobre o senhor. O relatório do fornecedor não o cobre.",
        ro: "Atât obligația de raportare prevăzută la articolul 23, cât și obligația de notificare a clienților prevăzută la articolul 36 revin dumneavoastră. Raportul furnizorului nu vă acoperă.",
      },
    },
  ],
});
