  ...
  questions: [
    {
      ...
      question: {
        ...
        cs: "Jaké tři osobní povinnosti vytváří článek 20(1) pro řídicí orgán?",
        pt: "Que três deveres pessoais cria o artigo 20(1) para o órgão de administração?",
        ro: "Ce trei obligații personale creează articolul 20(1) pentru organul de conducere?",
      },
      options: [
        { en: "Register, report, and train", de: "Registrieren, melden und schulen", nl: "Registreren, rapporteren en trainen", fr: "Enregistrer, notifier et former", it: "Registrare, notificare e formare", es: "Registrar, notificar y formar", pl: "Rejestrować, zgłaszać i szkolić", cs: "Registrovat, ohlašovat a vzdělávat se", pt: "Registar, notificar e formar-se", ro: "Înregistrare, raportare și formare" },
        { en: "Approve, oversee, and be liable", de: "Genehmigen, überwachen und haften", nl: "Goedkeuren, toezicht houden en aansprakelijk zijn", fr: "Approuver, superviser et être responsable", it: "Approvare, sorvegliare ed essere responsabile", es: "Aprobar, supervisar y ser responsable", pl: "Zatwierdzać, nadzorować i ponosić odpowiedzialność", cs: "Schvalovat, dohlížet a nést odpovědnost", pt: "Aprovar, supervisionar e ser responsável", ro: "Aprobare, supraveghere și răspundere" },
        { en: "Plan, implement, and audit", de: "Planen, umsetzen und prüfen", nl: "Plannen, implementeren en controleren", fr: "Planifier, mettre en œuvre et auditer", it: "Pianificare, attuare e verificare", es: "Planificar, implementar y auditar", pl: "Planować, wdrażać i audytować", cs: "Plánovat, zavádět a auditovat", pt: "Planear, implementar e auditar", ro: "Planificare, implementare și audit" },
        { en: "Budget, hire, and delegate", de: "Budgetieren, einstellen und delegieren", nl: "Begroten, aanwerven en delegeren", fr: "Budgétiser, recruter et déléguer", it: "Definire il budget, assumere e delegare", es: "Presupuestar, contratar y delegar", pl: "Budżetować, zatrudniać i delegować", cs: "Rozpočtovat, najímat a delegovat", pt: "Orçamentar, contratar e delegar", ro: "Bugetare, angajare și delegare" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Článek 20(1) vytváří tři povinnosti: schválit opatření, dohlížet na jejich zavádění a nést odpovědnost za porušení.",
        pt: "O artigo 20(1) cria três deveres: aprovar as medidas, supervisionar a sua implementação e ser responsável pelas infrações.",
        ro: "Articolul 20(1) creează trei obligații: aprobarea măsurilor, supravegherea implementării acestora și răspunderea pentru încălcări.",
      },
    },
    {
      id: "1.5.2",
      question: {
        ...
        cs: "Může CISO schvalovat kybernetická bezpečnostní opatření jménem řídicího orgánu?",
        pt: "Pode o CISO aprovar as medidas de cibersegurança em nome do órgão de administração?",
        ro: "Poate CISO să aprobe măsurile de securitate cibernetică în numele organului de conducere?",
      },
      options: [
        { en: "Yes, if the CEO delegates in writing", de: "Ja, wenn der Geschäftsführer schriftlich delegiert", nl: "Ja, als de CEO schriftelijk delegeert", fr: "Oui, si le dirigeant délègue par écrit", it: "Sì, se l'amministratore delegato delega per iscritto", es: "Sí, si el director general lo delega por escrito", pl: "Tak, jeśli dyrektor generalny przekaże uprawnienia na piśmie", cs: "Ano, pokud to generální ředitel písemně deleguje", pt: "Sim, se o diretor executivo delegar por escrito", ro: "Da, dacă directorul general deleagă în scris" },
        { en: "Yes, the CISO is the natural approver", de: "Ja, der CISO ist der natürliche Genehmiger", nl: "Ja, de CISO is de aangewezen goedkeurder", fr: "Oui, le CISO est l'approbateur naturel", it: "Sì, il CISO è l'approvatore naturale", es: "Sí, el CISO es el aprobador natural", pl: "Tak, CISO jest naturalną osobą zatwierdzającą", cs: "Ano, CISO je přirozeným schvalovatelem", pt: "Sim, o CISO é o aprovador natural", ro: "Da, CISO este aprobatorul firesc" },
        { en: "No, the CISO can implement but only the management body can approve", de: "Nein, der CISO kann umsetzen, aber nur die Geschäftsleitung kann genehmigen", nl: "Nee, de CISO kan implementeren, maar alleen het leidinggevend orgaan kan goedkeuren", fr: "Non, le CISO peut mettre en œuvre, mais seul l'organe de direction peut approuver", it: "No, il CISO può attuare, ma solo l'organo di gestione può approvare", es: "No, el CISO puede implementar, pero solo el órgano de dirección puede aprobar", pl: "Nie, CISO może wdrażać, ale tylko organ zarządzający może zatwierdzać", cs: "Ne, CISO může opatření zavádět, ale schválit je může pouze řídicí orgán", pt: "Não, o CISO pode implementar, mas só o órgão de administração pode aprovar", ro: "Nu, CISO poate implementa, dar numai organul de conducere poate aproba" },
        { en: "Only if the supervisory board agrees", de: "Nur wenn der Aufsichtsrat zustimmt", nl: "Alleen als de raad van commissarissen ermee instemt", fr: "Uniquement si le conseil de surveillance est d'accord", it: "Solo se il consiglio di sorveglianza è d'accordo", es: "Solo si el consejo de supervisión está de acuerdo", pl: "Tylko jeśli rada nadzorcza wyrazi zgodę", cs: "Pouze pokud s tím souhlasí dozorčí rada", pt: "Apenas se o conselho de supervisão concordar", ro: "Doar dacă consiliul de supraveghere este de acord" },
      ],
      correctIndex: 2,
      explanation: {
        ...
        cs: "Tuto povinnost nelze delegovat. CISO může opatření zavádět. Schválit je může pouze řídicí orgán.",
        pt: "O dever não pode ser delegado. O CISO pode implementar as medidas. Só o órgão de administração as pode aprovar.",
        ro: "Obligația nu poate fi delegată. CISO poate implementa măsurile. Numai organul de conducere le poate aproba.",
      },
    },
    {
      id: "1.5.3",
      question: {
        ...
        cs: "Co se stane, pokud se generální ředitel vyjme z opatření, která sám schválil?",
        pt: "O que acontece se um diretor executivo se isentar dos controlos que aprovou?",
        ro: "Ce se întâmplă dacă un director general se exceptează de la controalele pe care le-a aprobat?",
      },
      options: [
        { en: "Nothing, as long as the staff follows the controls", de: "Nichts, solange die Mitarbeitenden die Kontrollen einhalten", nl: "Niets, zolang het personeel de controles naleeft", fr: "Rien, tant que le personnel respecte les contrôles", it: "Niente, finché il personale rispetta i controlli", es: "Nada, siempre que el personal cumpla los controles", pl: "Nic, dopóki personel przestrzega kontroli", cs: "Nic, pokud opatření dodržují zaměstnanci", pt: "Nada, desde que o pessoal cumpra os controlos", ro: "Nimic, atât timp cât personalul respectă controalele" },
        { en: "It is a direct violation of the leading-by-example principle and an auditor can cite it as a finding", de: "Es ist ein direkter Verstoß gegen das Prinzip der Vorbildfunktion und ein Prüfer kann es als Feststellung beanstanden", nl: "Het is een directe schending van het principe van voorbeeldgedrag en een auditor kan dit als bevinding aanmerken", fr: "Il s'agit d'une violation directe du principe d'exemplarité et un auditeur peut la relever comme constatation", it: "Si tratta di una violazione diretta del principio di esemplarità e un revisore può citarla come rilievo", es: "Es una violación directa del principio de liderazgo con el ejemplo y un auditor puede señalarlo como hallazgo", pl: "Jest to bezpośrednie naruszenie zasady dawania przykładu i audytor może uznać to za ustalenie", cs: "Je to přímé porušení zásady jít příkladem a auditor to může uvést jako zjištění", pt: "Constitui uma violação direta do princípio de liderar pelo exemplo e um auditor pode citá-lo como uma constatação", ro: "Constituie o încălcare directă a principiului conducerii prin exemplu, iar un auditor o poate consemna ca o constatare" },
        { en: "It is permitted for the CEO but not for other board members", de: "Es ist für den Geschäftsführer erlaubt, aber nicht für andere Vorstandsmitglieder", nl: "Het is toegestaan voor de CEO maar niet voor andere bestuursleden", fr: "C'est autorisé pour le dirigeant mais pas pour les autres membres du conseil", it: "È consentito all'amministratore delegato ma non agli altri membri del consiglio", es: "Está permitido para el director general pero no para los demás miembros del consejo", pl: "Jest to dozwolone dla dyrektora generalnego, ale nie dla pozostałych członków zarządu", cs: "Generálnímu řediteli je to dovoleno, ostatním členům orgánu nikoli", pt: "É permitido ao diretor executivo, mas não aos restantes membros do órgão de administração", ro: "Este permis directorului general, dar nu și celorlalți membri ai organului de conducere" },
        { en: "The CISO must report it to the regulator", de: "Der CISO muss es der Aufsichtsbehörde melden", nl: "De CISO moet het melden bij de toezichthouder", fr: "Le CISO doit le signaler à l'autorité de contrôle", it: "Il CISO deve segnalarlo all'autorità di vigilanza", es: "El CISO debe notificarlo a la autoridad reguladora", pl: "CISO musi zgłosić to organowi nadzoru", cs: "CISO to musí nahlásit regulačnímu orgánu", pt: "O CISO tem de comunicá-lo à autoridade reguladora", ro: "CISO trebuie să raporteze acest lucru autorității de reglementare" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Opatření, která jste schválili, musíte osobně dodržovat. Vyjmout sám sebe je přímé porušení a může být uvedeno jako zjištění auditu.",
        pt: "Tem de cumprir pessoalmente os controlos que aprovou. Isentar-se é uma violação direta e pode ser citado como uma constatação de auditoria.",
        ro: "Trebuie să respectați personal controalele pe care le-ați aprobat. Exceptarea de la acestea este o încălcare directă și poate fi consemnată ca o constatare de audit.",
      },
    },
  ],
});
