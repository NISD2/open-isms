  ...
  questions: [
    {
      ...
      explanation: {
        ...
        cs: "Článek 23(2) se uplatní sám a spustí se v okamžiku, kdy se subjekt o přetrvávající hrozbě dozví. Článek 36 je pravomoc regulačního orgánu nařídit oznámení zákazníkům.",
        pt: "O artigo 23(2) é autoexecutável e aciona-se no momento em que a entidade toma conhecimento da ameaça em curso. O artigo 36 é o poder da autoridade reguladora de ordenar a notificação aos clientes.",
        ro: "Articolul 23(2) se autoexecută și se declanșează în momentul în care entitatea ia cunoștință de amenințarea în curs. Articolul 36 reprezintă competența autorității de reglementare de a dispune notificarea clienților.",
      },
    },
    {
      id: "1.12.2",
      question: {
        ...
        cs: "Co musíte podle článku 23(2) sdělit zákazníkům nad rámec toho, že nastal problém?",
        pt: "Nos termos do artigo 23(2), o que tem de comunicar aos clientes para além do facto de existir um problema?",
        ro: "Conform articolului 23(2), ce trebuie să comunicați clienților dincolo de faptul că există o problemă?",
      },
      options: [
        { en: "Nothing else is required", de: "Es sind keine weiteren Angaben erforderlich", nl: "Er zijn geen verdere mededelingen vereist", fr: "Aucune autre indication n'est requise", it: "Non è richiesta alcuna altra informazione", es: "No se requiere ninguna otra información", pl: "Nie są wymagane żadne dalsze informacje", cs: "Nic dalšího se nevyžaduje", pt: "Nada mais é exigido", ro: "Nu se mai cere nimic altceva" },
        { en: "The name of the attacker and their methods", de: "Den Namen des Angreifers und seine Methoden", nl: "De naam van de aanvaller en hun methoden", fr: "Le nom de l'attaquant et ses méthodes", it: "Il nome dell'aggressore e i suoi metodi", es: "El nombre del atacante y sus métodos", pl: "Nazwę napastnika i jego metody", cs: "Jméno útočníka a jeho metody", pt: "O nome do atacante e os seus métodos", ro: "Numele atacatorului și metodele acestuia" },
        { en: "Any measures or remedies the recipients can take in response to the threat", de: "Alle Maßnahmen oder Abhilfemöglichkeiten, die die Empfänger als Reaktion auf die Bedrohung ergreifen können", nl: "Alle maatregelen of herstelacties die de ontvangers kunnen nemen als reactie op de dreiging", fr: "Toutes les mesures ou solutions que les destinataires peuvent prendre en réponse à la menace", it: "Tutte le misure o i rimedi che i destinatari possono adottare in risposta alla minaccia", es: "Cualquier medida o solución que los destinatarios puedan adoptar en respuesta a la amenaza", pl: "Wszelkie środki lub rozwiązania, które odbiorcy mogą podjąć w odpowiedzi na zagrożenie", cs: "Veškerá opatření nebo nápravné kroky, které mohou příjemci v reakci na hrozbu přijmout", pt: "Quaisquer medidas ou soluções que os destinatários possam adotar em resposta à ameaça", ro: "Orice măsuri sau remedii pe care destinatarii le pot lua ca răspuns la amenințare" },
        { en: "The amount of the fine the company expects to receive", de: "Die Höhe des Bußgeldes, das das Unternehmen erwartet", nl: "De hoogte van de boete die de vennootschap verwacht te ontvangen", fr: "Le montant de l'amende que l'entreprise s'attend à recevoir", it: "L'importo della sanzione che l'impresa si aspetta di ricevere", es: "El importe de la multa que la empresa espera recibir", pl: "Wysokość kary, jakiej spodziewa się firma", cs: "Výši pokuty, kterou společnost očekává", pt: "O montante da coima que a empresa espera receber", ro: "Cuantumul amenzii pe care compania se așteaptă să o primească" },
      ],
      correctIndex: 2,
      explanation: {
        ...
        cs: "Článek 23(2) vyžaduje, abyste sdělili veškerá opatření nebo nápravné kroky, které mohou příjemci v reakci na hrozbu přijmout.",
        pt: "O artigo 23(2) exige que divulgue quaisquer medidas ou soluções que os destinatários possam adotar em resposta à ameaça.",
        ro: "Articolul 23(2) impune să divulgați orice măsuri sau remedii pe care destinatarii le pot lua ca răspuns la amenințare.",
      },
    },
    {
      id: "1.12.3",
      question: {
        ...
        cs: "Co lekce doporučuje mít připraveno dříve, než dojde k incidentu?",
        pt: "O que recomenda a lição ter preparado antes de ocorrer um incidente?",
        ro: "Ce recomandă lecția să aveți pregatit înainte de a survine un incident?",
      },
      options: [
        { en: "A press release template and social media strategy", de: "Eine Pressemitteilungsvorlage und Social-Media-Strategie", nl: "Een persbericht-sjabloon en sociale-mediastrategie", fr: "Un modèle de communiqué de presse et une stratégie de médias sociaux", it: "Un modello di comunicato stampa e una strategia per i social media", es: "Una plantilla de comunicado de prensa y una estrategia de redes sociales", pl: "Szablon komunikatu prasowego i strategię mediów społecznościowych", cs: "Šablonu tiskové zprávy a strategii pro sociální sítě", pt: "Um modelo de comunicado de imprensa e uma estratégia para redes sociais", ro: "Un model de comunicat de presă și o strategie pentru rețelele sociale" },
        { en: "A pre-drafted customer notification template and a defined approval chain ending with the management body", de: "Eine vorbereitete Kundenbenachrichtigungsvorlage und eine definierte Freigabekette, die bei der Geschäftsleitung endet", nl: "Een vooraf opgesteld klantnotificatiesjabloon en een vastgestelde goedkeuringsketen die eindigt bij het leidinggevend orgaan", fr: "Un modèle de notification aux clients pré-rédigé et une chaîne d'approbation définie se terminant par l'organe de direction", it: "Un modello di notifica ai clienti già predisposto e una catena di approvazione definita che termina con l'organo di gestione", es: "Una plantilla de notificación a los clientes redactada de antemano y una cadena de aprobación definida que termina en el órgano de dirección", pl: "Wcześniej przygotowany szablon powiadomienia klientów oraz zdefiniowaną ścieżkę zatwierdzania kończącą się na organie zarządzającym", cs: "Předem připravenou šablonu oznámení zákazníkům a vymezený schvalovací řetězec končící u řídicího orgánu", pt: "Um modelo de notificação aos clientes previamente redigido e uma cadeia de aprovação definida que termina no órgão de administração", ro: "Un model de notificare a clienților redactat în prealabil și un lanț de aprobare definit care se încheie la organul de conducere" },
        { en: "An insurance claim form and legal retainer agreement", de: "Ein Versicherungsschadenformular und eine Mandatsvereinbarung", nl: "Een verzekeringsschadeclaimformulier en een mandaatovereenkomst", fr: "Un formulaire de déclaration de sinistre et un contrat de mandat juridique", it: "Un modulo di richiesta di risarcimento assicurativo e un contratto di mandato legale", es: "Un formulario de reclamación al seguro y un contrato de retención jurídica", pl: "Formularz zgłoszenia szkody ubezpieczeniowej i umowę o stałą obsługę prawną", cs: "Formulář pojistné události a smlouvu o právním zastoupení", pt: "Um formulário de participação de sinistro e um contrato de avença jurídica", ro: "Un formular de cerere de despăgubire și un contract de reprezentare juridică" },
        { en: "A list of customers ranked by revenue for priority notification", de: "Eine nach Umsatz sortierte Kundenliste für priorisierte Benachrichtigung", nl: "Een lijst van klanten gerangschikt op omzet voor prioriteitsnotificatie", fr: "Une liste de clients classés par chiffre d'affaires pour une notification prioritaire", it: "Un elenco di clienti ordinati per fatturato per la notifica prioritaria", es: "Una lista de clientes ordenados por facturación para una notificación prioritaria", pl: "Listę klientów uszeregowaną według przychodów na potrzeby priorytetowego powiadamiania", cs: "Seznam zákazníků seřazený podle tržeb pro přednostní oznamování", pt: "Uma lista de clientes ordenada por receita para notificação prioritária", ro: "O listă de clienți clasați după venituri pentru notificare prioritară" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Mějte předem připravenou šablonu oznámení zákazníkům a vymezený schvalovací řetězec, který končí u řídicího orgánu.",
        pt: "Tenha um modelo de notificação aos clientes previamente redigido e uma cadeia de aprovação definida que termina no órgão de administração.",
        ro: "Aveți un model de notificare a clienților redactat în prealabil și un lanț de aprobare definit care se încheie la organul de conducere.",
      },
    },
  ],
});
