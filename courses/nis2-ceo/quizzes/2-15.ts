  ...
  questions: [
    {
      ...
      question: {
        ...
        cs: "Pro které čtyři kategorie je vícefaktorové ověřování (MFA) pro subjekt NIS2 fakticky povinné?",
        pt: "Para que quatro categorias é a autenticação multifator (MFA) efetivamente obrigatória para uma entidade NIS2?",
        ro: "Pentru care patru categorii este autentificarea multifactor (MFA) efectiv obligatorie pentru o entitate NIS2?",
      },
      options: [
        { en: "Personal email, social media, personal banking, and personal devices", de: "Private E-Mail, soziale Medien, privates Banking und persönliche Geräte", nl: "Persoonlijke e-mail, sociale media, persoonlijk bankieren en persoonlijke apparaten", fr: "La messagerie personnelle, les réseaux sociaux, la banque personnelle et les appareils personnels", it: "E-mail personale, social media, home banking personale e dispositivi personali", es: "Correo electrónico personal, redes sociales, banca personal y dispositivos personales", pl: "Prywatna poczta e-mail, media społecznościowe, bankowość prywatna i urządzenia osobiste", cs: "Osobní e-mail, sociální sítě, osobní bankovnictví a osobní zařízení", pt: "Correio eletrónico pessoal, redes sociais, banca pessoal e dispositivos pessoais", ro: "E-mail personal, rețele sociale, servicii bancare personale și dispozitive personale" },
        { en: "Remote access, administrator accounts, critical systems, and email", de: "Fernzugriff, Administratorkonten, kritische Systeme und E-Mail", nl: "Toegang op afstand, beheerdersaccounts, kritieke systemen en e-mail", fr: "L'accès à distance, les comptes administrateurs, les systèmes critiques et la messagerie", it: "Accesso remoto, account amministratore, sistemi critici ed e-mail", es: "Acceso remoto, cuentas de administrador, sistemas críticos y correo electrónico", pl: "Dostęp zdalny, konta administratorów, systemy krytyczne i poczta e-mail", cs: "Vzdálený přístup, administrátorské účty, kritické systémy a e-mail", pt: "Acesso remoto, contas de administrador, sistemas críticos e correio eletrónico", ro: "Acces la distanță, conturi de administrator, sisteme critice și e-mail" },
        { en: "Marketing tools, HR systems, accounting software, and the company website", de: "Marketing-Tools, HR-Systeme, Buchhaltungssoftware und die Unternehmenswebsite", nl: "Marketingtools, HR-systemen, boekhoudsoftware en de bedrijfswebsite", fr: "Les outils marketing, les systèmes RH, les logiciels de comptabilité et le site web de l'entreprise", it: "Strumenti di marketing, sistemi HR, software di contabilità e il sito web aziendale", es: "Herramientas de marketing, sistemas de RR. HH., software de contabilidad y el sitio web de la empresa", pl: "Narzędzia marketingowe, systemy kadrowe, oprogramowanie księgowe i strona internetowa firmy", cs: "Marketingové nástroje, personální systémy, účetní software a firemní web", pt: "Ferramentas de marketing, sistemas de recursos humanos, software de contabilidade e o sítio Web da empresa", ro: "Instrumente de marketing, sisteme de resurse umane, software de contabilitate și site-ul web al companiei" },
        { en: "Board meetings, investor portals, press releases, and internal chat", de: "Vorstandssitzungen, Investorenportale, Pressemitteilungen und interner Chat", nl: "Bestuursvergaderingen, investeerdersportalen, persberichten en interne chat", fr: "Les réunions du conseil, les portails investisseurs, les communiqués de presse et la messagerie interne", it: "Riunioni del consiglio, portali per investitori, comunicati stampa e chat interna", es: "Reuniones del consejo, portales de inversores, comunicados de prensa y chat interno", pl: "Posiedzenia zarządu, portale inwestorskie, komunikaty prasowe i czat wewnętrzny", cs: "Jednání orgánu, investorské portály, tiskové zprávy a interní chat", pt: "Reuniões do órgão de administração, portais de investidores, comunicados de imprensa e conversação interna", ro: "Ședințele organului de conducere, portalurile investitorilor, comunicatele de presă și conversațiile interne" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "MFA je fakticky povinné u vzdáleného přístupu, administrátorských účtů, kritických systémů (databáze, zálohy, platební systémy) a e-mailu.",
        pt: "A MFA é efetivamente obrigatória no acesso remoto, nas contas de administrador, nos sistemas críticos (bases de dados, cópias de segurança, sistemas de pagamento) e no correio eletrónico.",
        ro: "MFA este efectiv obligatorie pentru accesul la distanță, conturile de administrator, sistemele critice (baze de date, copii de rezervă, sisteme de plată) și e-mail.",
      },
    },
    {
      id: "2.15.2",
      question: {
        ...
        cs: "Co je 'kanál mimo pásmo' a proč je potřeba?",
        pt: "O que é um 'canal fora de banda' e por que é necessário?",
        ro: "Ce este un 'canal în afara benzii' și de ce este necesar?",
      },
      options: [
        { en: "A backup internet connection; needed for faster downloads", de: "Eine Backup-Internetverbindung; benötigt für schnellere Downloads", nl: "Een reserveinternetverbinding; nodig voor snellere downloads", fr: "Une connexion internet de secours ; nécessaire pour des téléchargements plus rapides", it: "Una connessione internet di backup; necessaria per download più veloci", es: "Una conexión a internet de respaldo; necesaria para descargas más rápidas", pl: "Zapasowe połączenie internetowe; potrzebne do szybszego pobierania", cs: "Záložní připojení k internetu, potřebné pro rychlejší stahování", pt: "Uma ligação de Internet de reserva, necessária para descarregamentos mais rápidos", ro: "O conexiune de internet de rezervă, necesară pentru descărcări mai rapide" },
        { en: "A separate emergency communication path that works when normal systems are compromised", de: "Ein separater Notfallkommunikationsweg, der funktioniert, wenn die normalen Systeme kompromittiert sind", nl: "Een apart noodcommunicatiepad dat werkt wanneer normale systemen gecompromitteerd zijn", fr: "Une voie de communication d'urgence distincte qui fonctionne lorsque les systèmes normaux sont compromis", it: "Un percorso di comunicazione d'emergenza separato che funziona quando i sistemi normali sono compromessi", es: "Una vía de comunicación de emergencia independiente que funciona cuando los sistemas normales están comprometidos", pl: "Oddzielna awaryjna ścieżka komunikacji, która działa, gdy normalne systemy są skompromitowane", cs: "Samostatnou nouzovou komunikační cestu, která funguje, když jsou běžné systémy kompromitovány", pt: "Uma via de comunicação de emergência separada que funciona quando os sistemas normais estão comprometidos", ro: "O cale de comunicare de urgență separată care funcționează atunci când sistemele obișnuite sunt compromise" },
        { en: "An encrypted email service; needed for regulatory compliance", de: "Ein verschlüsselter E-Mail-Dienst; benötigt für regulatorische Compliance", nl: "Een versleutelde e-mailservice; nodig voor naleving van regelgeving", fr: "Un service de messagerie chiffré ; nécessaire à la conformité réglementaire", it: "Un servizio di posta elettronica crittografato; necessario per la conformità normativa", es: "Un servicio de correo electrónico cifrado; necesario para el cumplimiento normativo", pl: "Szyfrowana usługa poczty e-mail; potrzebna do zgodności regulacyjnej", cs: "Šifrovanou e-mailovou službu, potřebnou pro soulad s předpisy", pt: "Um serviço de correio eletrónico cifrado, necessário para a conformidade regulamentar", ro: "Un serviciu de e-mail criptat, necesar pentru conformitatea cu reglementările" },
        { en: "A public communication channel for press releases during incidents", de: "Ein öffentlicher Kommunikationskanal für Pressemitteilungen bei Vorfällen", nl: "Een openbaar communicatiekanaal voor persberichten tijdens incidenten", fr: "Un canal de communication public pour les communiqués de presse lors des incidents", it: "Un canale di comunicazione pubblico per i comunicati stampa durante gli incidenti", es: "Un canal de comunicación público para los comunicados de prensa durante los incidentes", pl: "Publiczny kanał komunikacji do komunikatów prasowych podczas incydentów", cs: "Veřejný komunikační kanál pro tiskové zprávy během incidentů", pt: "Um canal de comunicação público para comunicados de imprensa durante incidentes", ro: "Un canal de comunicare public pentru comunicate de presă în timpul incidentelor" },
      ],
      correctIndex: 1,
      explanation: {
        ...
        cs: "Kanál mimo pásmo je samostatná komunikační cesta (samostatný nástroj pro zasílání zpráv, vyhrazená telefonní linka) pro případ, kdy běžné systémy nefungují. Pokud krizový plán spoléhá na e-mail a e-mail je kompromitován, plán selže.",
        pt: "Um canal fora de banda é uma via de comunicação separada (ferramenta de mensagens separada, linha telefónica dedicada) para quando os sistemas normais estão em baixo. Se o plano de crise depender do correio eletrónico e este estiver comprometido, falha.",
        ro: "Un canal în afara benzii este o cale de comunicare separată (un instrument de mesagerie separat, o linie telefonică dedicată) pentru momentele în care sistemele obișnuite sunt indisponibile. Dacă planul de criză se bazează pe e-mail, iar e-mailul este compromis, planul eșuează.",
      },
    },
    {
      id: "2.15.3",
      ...
      explanation: {
        ...
        cs: "Zásada 6 normy BSI-Standard 200-1 vyjmenovává povinnost řídicího orgánu jít příkladem. Generální ředitel, který schválil MFA, ale vyňal vlastní přihlášení, vytváří osobní zjištění auditu.",
        pt: "O Princípio 6 da norma BSI-Standard 200-1 designa o dever do órgão de administração de liderar pelo exemplo. Um diretor executivo que aprovou a MFA mas isentou o seu próprio acesso cria uma constatação de auditoria pessoal.",
        ro: "Principiul 6 din BSI-Standard 200-1 desemnează obligația organului de conducere de a conduce prin exemplu. Un director general care a aprobat MFA, dar a exceptat propria autentificare, creează o constatare de audit personală.",
      },
    },
  ],
});
