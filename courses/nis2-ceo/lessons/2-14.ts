...
const lesson = lessonSchema.parse({
  ...
  title: { en: "Measure 9 - HR Security, Access Control, and Asset Management", nl: "Maatregel 9 - HR-beveiliging, toegangscontrole en middelenbeheer", de: "Maßnahme 9 - Personalsicherheit, Zugriffskontrolle und Asset-Management", fr: "Mesure 9 - Sécurité RH, contrôle d'accès et gestion des actifs", it: "Misura 9 - Sicurezza delle risorse umane, controllo degli accessi e gestione degli asset", es: "Medida 9 - Seguridad de RR. HH., control de acceso y gestión de activos", pl: "Środek 9 - Bezpieczeństwo kadrowe, kontrola dostępu i zarządzanie aktywami", cs: "Opatření 9 - Personální bezpečnost, řízení přístupu a správa aktiv", pt: "Medida 9 - Segurança de RH, controlo de acessos e gestão de ativos", ro: "Măsura 9 - Securitatea personalului, controlul accesului și gestionarea activelor" },
  moduleId: "module-2",
  order: 13,
  contentFile: "2-14",
  videoUrl: undefined,
