...
export const managedServicesFields: SupplierField[] = [
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Administrátorské relace jsou nahrávány",
      pt: "As sessões de administração são gravadas",
      ro: "Sesiunile de administrare sunt înregistrate",
    },
    description: {
      ...
      cs: "Zaškrtněte ano, pokud jsou administrátorské relace na systémech zákazníků nahrávány a uchovávány k přezkoumání. Obvyklá doba uchování: 90 dní až 1 rok. Nezbytné pro forenzní rekonstrukci po incidentech.",
      pt: "Assinale sim se as sessões de administração nos sistemas dos clientes forem gravadas e conservadas para revisão. Conservação habitual: de 90 dias a 1 ano. Necessária para a reconstrução forense após incidentes.",
      ro: "Bifați da dacă sesiunile de administrare pe sistemele clienților sunt înregistrate și păstrate pentru verificare. Păstrare uzuală: de la 90 de zile la 1 an. Necesară pentru reconstrucția criminalistică după incidente.",
    },
  ...
  },
  {
    ...
    label: {
      ...
      pl: "Dyżur 24/7",
      cs: "Pohotovost 24/7",
      pt: "Cobertura de prevenção 24/7",
      ro: "Acoperire de gardă 24/7",
    },
    description: {
      ...
      cs: "Zaškrtněte ano, pokud provozujete pohotovostní službu 24/7, která reaguje na bezpečnostní incidenty na systémech zákazníků. Podpora pouze v pracovní době tomuto požadavku nevyhovuje.",
      pt: "Assinale sim se mantiver um regime de prevenção 24/7 que responde a incidentes de segurança nos sistemas dos clientes. O suporte limitado ao horário de expediente não cumpre o requisito.",
      ro: "Bifați da dacă mențineți o gardă 24/7 care răspunde la incidentele de securitate de pe sistemele clienților. Suportul limitat la programul de lucru nu îndeplinește cerința.",
    },
