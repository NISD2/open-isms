...
export const impactFields: ReadonlyArray<IncidentField> = [
  {
    ...
    label: {
      ...
      cs: "Dotčení uživatelé (odhad)",
      pt: "Utilizadores afetados (estimativa)",
      ro: "Utilizatori afectați (estimare)",
    },
    description: {
      ...
      cs: "Odhadovaný počet dotčených uživatelů. CIR 2024/2690 kvantifikuje prahové hodnoty pro kategorie poskytovatelů digitálních služeb, na které se vztahuje; u ostatních subjektů je posouzení kvalitativní podle čl. 6 odst. 6 a čl. 23 odst. 3 NIS 2.",
      pt: "Número estimado de utilizadores afetados. O CIR 2024/2690 quantifica limiares para as categorias de prestadores de serviços digitais que abrange; para as restantes entidades, a avaliação é qualitativa nos termos do art. 6.º, n.º 6, e do art. 23.º, n.º 3, da NIS 2.",
      ro: "Numărul estimat de utilizatori afectați. CIR 2024/2690 cuantifică praguri pentru categoriile de furnizori de servicii digitale pe care le reglementează; pentru celelalte entități, evaluarea este calitativă în temeiul art. 6 alin. (6) și al art. 23 alin. (3) din NIS 2.",
    },
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Popis narušení služby",
      pt: "Descrição da interrupção do serviço",
      ro: "Descrierea perturbării serviciului",
    },
    description: {
      ...
      cs: "Popis toho, které služby (provozní, určené zákazníkům, interní) byly degradovány nebo nedostupné a po jak dlouhou dobu. Čl. 6 odst. 6 NIS 2 činí z narušení služby kritérium definující 'významný incident'.",
      pt: "Descrição de quais serviços (operacionais, voltados para o cliente, internos) foram degradados ou ficaram indisponíveis e durante quanto tempo. O art. 6.º, n.º 6, da NIS 2 faz da interrupção do serviço um critério que define um 'incidente significativo'.",
      ro: "Descrierea serviciilor (operaționale, destinate clienților, interne) care au fost degradate sau indisponibile și pentru cât timp. Art. 6 alin. (6) din NIS 2 face din perturbarea serviciului un criteriu care definește un 'incident semnificativ'.",
    },
    requiredIn: [REPORT_TYPE.INCIDENT_NOTIFICATION, REPORT_TYPE.FINAL],
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Odhadovaná finanční škoda (EUR)",
      pt: "Dano financeiro estimado (EUR)",
      ro: "Daune financiare estimate (EUR)",
    },
    description: {
      ...
      cs: "Odhadovaná přímá a nepřímá finanční škoda. Čl. 6 odst. 6 NIS 2 řadí finanční ztrátu mezi kritéria, která povyšují incident na 'významný'.",
      pt: "Dano financeiro direto e indireto estimado. O art. 6.º, n.º 6, da NIS 2 inclui a perda financeira entre os critérios que elevam um incidente a 'significativo'.",
      ro: "Daune financiare directe și indirecte estimate. Art. 6 alin. (6) din NIS 2 include pierderea financiară printre criteriile care ridică un incident la rangul de 'semnificativ'.",
    },
    requiredIn: [],
    optionalIn: [
      REPORT_TYPE.EARLY_WARNING,
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Reputační škoda (ano / ne)",
      pt: "Dano reputacional (sim / não)",
      ro: "Prejudiciu reputațional (da / nu)",
    },
    description: {
      ...
      cs: "Posouzení subjektu, zda incident způsobil nebo pravděpodobně způsobí reputační škodu. Jedno z kvalifikačních kritérií pro 'významný incident' podle čl. 6 odst. 6 NIS 2.",
      pt: "Avaliação da entidade sobre se o incidente causou ou é provável que cause dano reputacional. Um dos critérios que qualificam um 'incidente significativo' nos termos do art. 6.º, n.º 6, da NIS 2.",
      ro: "Evaluarea entității cu privire la faptul că incidentul a cauzat sau este probabil să cauzeze un prejudiciu reputațional. Unul dintre criteriile care califică un 'incident semnificativ' în temeiul art. 6 alin. (6) din NIS 2.",
    },
    requiredIn: [REPORT_TYPE.INCIDENT_NOTIFICATION, REPORT_TYPE.FINAL],
    optionalIn: [REPORT_TYPE.EARLY_WARNING, REPORT_TYPE.INTERMEDIATE, REPORT_TYPE.PROGRESS],
    legalBasis: [
