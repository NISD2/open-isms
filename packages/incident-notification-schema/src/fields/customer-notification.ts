...
export const customerNotificationFields: ReadonlyArray<IncidentField> = [
  {
    ...
    label: {
      ...
      cs: "Informovat příjemce služeb (čl. 23(2))",
      pt: "Informar os destinatários dos serviços (art. 23.º(2))",
      ro: "Informarea destinatarilor serviciilor (art. 23(2))",
    },
    description: {
      ...
      cs: "Čl. 23(2) NIS 2: je-li to relevantní, subjekt bez zbytečného odkladu sdělí příjemcům svých služeb, kteří jsou potenciálně zasaženi významnou kybernetickou hrozbou, veškerá opatření nebo nápravná řešení, která mohou přijmout.",
      pt: "Art. 23.º(2) NIS 2: se for caso disso, a entidade comunica sem demora injustificada aos destinatários dos seus serviços que sejam potencialmente afetados por uma ciberameaça significativa quaisquer medidas ou soluções que possam adotar.",
      ro: "Art. 23(2) NIS 2: după caz, entitatea comunică fără întârziere nejustificată destinatarilor serviciilor sale care sunt potențial afectați de o amenințare cibernetică semnificativă orice măsuri sau remedii pe care le pot lua.",
    },
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Sdělení příjemcům služeb",
      pt: "Mensagem aos destinatários dos serviços",
      ro: "Mesaj către destinatarii serviciilor",
    },
    description: {
      ...
      cs: "Sdělení formulované srozumitelným jazykem pro příjemce služeb subjektu o hrozbě a doporučených nápravných opatřeních. Povinné, je-li customerNotificationRequired pravda.",
      pt: "Mensagem em linguagem clara dirigida aos destinatários dos serviços da entidade sobre a ameaça e as ações corretivas recomendadas. Obrigatória se customerNotificationRequired for verdadeiro.",
      ro: "Mesaj formulat într-un limbaj clar, adresat destinatarilor serviciilor entității cu privire la amenințare și la acțiunile corective recomandate. Obligatoriu dacă customerNotificationRequired este adevărat.",
    },
    requiredIn: [],
