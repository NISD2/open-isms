...
export const descriptionFields: ReadonlyArray<IncidentField> = [
  {
    ...
    label: {
      ...
      cs: "Stručné shrnutí incidentu",
      pt: "Resumo breve do incidente",
      ro: "Rezumat scurt al incidentului",
    },
    description: {
      ...
      cs: "Srozumitelné shrnutí toho, co se stalo. Čl. 23(4)(a) NIS 2 vyžaduje, aby včasné varování uvádělo, zda existuje podezření, že významný incident má protiprávní nebo zlovolnou povahu: toto pole obsahuje tento úvodní popis.",
      pt: "Resumo em linguagem clara do que aconteceu. O art. 23.º, n.º 4, alínea a), da NIS 2 exige que o alerta precoce indique se há suspeita de que o incidente significativo tem natureza ilícita ou maliciosa: este campo contém essa descrição inicial.",
      ro: "Rezumat în limbaj clar al celor întâmplate. Art. 23 alin. (4) lit. (a) din NIS 2 impune ca avertizarea timpurie să indice dacă se suspectează că incidentul semnificativ are caracter ilicit sau rău intenționat: acest câmp conține această descriere inițială.",
    },
    requiredIn: [
  ...
  },
  {
    ...
    label: {
      ...
      cs: "Podrobný popis incidentu",
      pt: "Descrição detalhada do incidente",
      ro: "Descriere detaliată a incidentului",
    },
    description: {
      ...
      cs: "Doslovně podle čl. 23(4)(d) NIS 2: závěrečná zpráva obsahuje 'podrobný popis incidentu, včetně jeho závažnosti a dopadu'. Toto pole shromažďuje zjištění v průběhu celého ohlašovacího cyklu.",
      pt: "Conforme o texto literal do art. 23.º, n.º 4, alínea d), da NIS 2: o relatório final contém 'uma descrição detalhada do incidente, incluindo a sua gravidade e o seu impacto'. Este campo acumula as constatações ao longo do ciclo de notificação.",
      ro: "Conform textului literal al art. 23 alin. (4) lit. (d) din NIS 2: raportul final conține 'o descriere detaliată a incidentului, inclusiv gravitatea și impactul acestuia'. Acest câmp adună constatările pe parcursul întregului ciclu de raportare.",
    },
  ...
  },
  {
    ...
    options: [
      { value: "suspected", label: { en: "Suspected", de: "Vermutet", fr: "Soupçonné", it: "Sospetto", es: "Sospechado", pl: "Podejrzewane", cs: "Podezření", pt: "Suspeito", ro: "Suspectat" } },
      { value: "confirmed", label: { en: "Confirmed", de: "Bestätigt", fr: "Confirmé", it: "Confermato", es: "Confirmado", pl: "Potwierdzone", cs: "Potvrzeno", pt: "Confirmado", ro: "Confirmat" } },
      { value: "ruledOut", label: { en: "Ruled out", de: "Ausgeschlossen", fr: "Écarté", it: "Escluso", es: "Descartado", pl: "Wykluczone", cs: "Vyloučeno", pt: "Excluído", ro: "Exclus" } },
      { value: "unknown", label: { en: "Unknown", de: "Unbekannt", fr: "Inconnu", it: "Sconosciuto", es: "Desconocido", pl: "Nieznane", cs: "Neznámé", pt: "Desconhecido", ro: "Necunoscut" } },
    ],
    label: {
      ...
      cs: "Podezření na protiprávní nebo zlovolnou příčinu",
      pt: "Suspeita de causa ilícita ou maliciosa",
      ro: "Cauză ilicită sau rău intenționată suspectată",
    },
    description: {
      ...
      cs: "Čl. 23(4)(a) NIS 2 vyžaduje, aby včasné varování do 24 hodin uvádělo, zda existuje podezření, že významný incident byl způsoben protiprávním nebo zlovolným jednáním.",
      pt: "O art. 23.º, n.º 4, alínea a), da NIS 2 exige que o alerta precoce de 24 horas indique se há suspeita de que o incidente significativo foi causado por atos ilícitos ou maliciosos.",
      ro: "Art. 23 alin. (4) lit. (a) din NIS 2 impune ca avertizarea timpurie în termen de 24 de ore să indice dacă se suspectează că incidentul semnificativ a fost cauzat de acte ilicite sau rău intenționate.",
    },
    requiredIn: [
      REPORT_TYPE.EARLY_WARNING,
      REPORT_TYPE.INCIDENT_NOTIFICATION,
