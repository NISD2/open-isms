...
CREATE TABLE "user" (
	...
	"is_disposable_email" boolean DEFAULT false NOT NULL,
	"phone" varchar(50),
	"email_followups_disabled" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX "idx_gap_assessment_company" ON "gap_assessment" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_training_progress_company_course" ON "training_lesson_progress" USING btree ("company_id","course_id");--> statement-breakpoint
...
CREATE INDEX "idx_vulnerability_status" ON "vulnerability" USING btree ("status");