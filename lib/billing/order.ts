 ...
 *
 * The VAT number is required because §7.8 records that a non-business cannot buy this product, and
 * because the country in it decides the tax treatment. The offline check digit is part of the
 ...
 * day they order, because §7.5 says access starts at order rather than at payment and the invoice
 * should describe the same thing the product does.
 */
