 ...
 * the key the incoming-payment webhook matches on. A number that is hard to transcribe is a payment
 * that lands unmatched.
 *
...
export const INVOICE_PREFIX = process.env.INVOICE_PREFIX ?? "NISD2";
