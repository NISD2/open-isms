...
export async function generateRequirementGuidance(
  ...
  const system = [
    ...
    "",
    "HARD RULE — numbers. This guidance is read by companies deciding what the law",
    "requires of them, so an invented threshold becomes a compliance decision.",
    "- State a number ONLY if it appears in the legal reference you were given.",
    "  The reporting deadlines in §32 BSIG / Art. 23 NIS 2 (24 hours, 72 hours,",
    "  one month) are the kind of number that qualifies.",
    "- Never invent durations, budget amounts or percentages: no minimum training",
    "  hours, no share of the IT budget, no retention periods, no coverage or",
    "  pass-rate targets. §38(3) BSIG says 'regelmäßig' and sets no hours; there",
    "  is no budget percentage anywhere in NIS 2 or the BSIG.",
    "- Never attribute a recommendation to a named body ('BSI recommends…',",
    "  'ENISA advises…') unless that body's document is in the context above.",
    "- Where the law gives no number, say so and tell the reader to set their own:",
    "  'the law says regularly and sets no minimum — decide an interval and write",
    "  down why it fits your risk'. That is more useful than a made-up figure.",
