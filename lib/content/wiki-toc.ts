...
const CATEGORY_SLUGS: Record<WikiTopLevel, PerLocaleSlug> = {
  ...
  "open-source": { de: "open-source", en: "open-source", nl: "open-source" },
  "zeit-und-status": {
    de: "zeit-und-status",
...
export const WIKI_TOC: Record<WikiTopLevel, WikiCategoryMeta> = {
  anwendungsbereich: {
    ...
    entries: [
      ...
      { slug: "nis2-selbsteinstufung", slugs: { de: "nis2-selbsteinstufung", en: "nis2-self-classification", nl: "nis2-zelf-classificatie" }, titleDe: "Selbsteinstufung nach NIS 2 — kein Brief vom BSI ist keine Verteidigung", titleEn: "Self-classification under NIS 2 — silence from the BSI is not a defence", summaryDe: "Die Pflicht zur Prüfung liegt auf der Einrichtung. Art. 3(4) NIS 2 + §33 BSIG. Die 3-Monats-Frist läuft mit Erfüllung der Voraussetzungen, nicht mit einer Mitteilung.", summaryEn: "The duty to assess sits with the entity. Art. 3(4) NIS 2 + §33 BSIG. The three-month clock starts when the conditions are met, not when a letter arrives.", authorSlug: "simon-orzel", tags: ["regulation:nis2", "regulation:bsig", "topic:scope", "topic:self-classification", "audience:ceo", "audience:lawyer", "level:beginner"], subCategory: "Geltungsbereich", audience: ["ceo", "lawyer"], relatedSlugs: ["wer-ist-betroffen-vollstaendiger-test", "nis2-registrierung", "nis2-einrichtungen"] },
    ],
  },
  sektoren: {
    slug: "sektoren",
  ...
  grundlagen: {
    ...
    entries: [
      ...
      {
        slug: "bsig-38",
        slugs: { de: "bsig-38", en: "bsig-38", nl: "bsig-38" },
        titleDe: "§ 38 BSIG: die Pflichten der Geschäftsleitung",
        titleEn: "Section 38 BSIG: management body obligations",
        summaryDe: "Die Pflichten der Geschäftsleitung aus § 38 BSIG: Risikomanagementmaßnahmen nach § 30 umsetzen und überwachen, an Schulungen teilnehmen, persönliche Innenhaftung nach Absatz 2, und das Verhältnis zu Artikel 20 NIS 2.",
        summaryEn: "The management body obligations under Section 38 BSIG: implementing and monitoring the Section 30 risk management measures, attending training, personal internal liability under subsection 2, and the relationship to Article 20 NIS 2.",
        authorSlug: "simon-orzel",
        tags: ["regulation:nis2", "regulation:bsig", "topic:governance", "topic:art-20", "topic:training", "audience:ceo", "audience:ciso", "audience:lawyer", "level:intermediate"],
        subCategory: "Pflichten",
        audience: ["ceo", "ciso", "lawyer"],
        relatedSlugs: ["bsig-30", "bsig-32", "geschaftsfuhrerhaftung", "geschaeftsleitungs-schulung-nis2"],
      },
      {
        slug: "cir-2024-2690",
  ...
  vergleich: {
    ...
    entries: [
      ...
      },
      {
        ...
        slugs: { de: "vanta-alternative", en: "vanta-alternative", nl: "vanta-alternatief" },
        titleDe: "Vanta-Alternative: der quelloffene Weg zu NIS 2",
        titleEn: "Vanta alternative: the open-source route to NIS 2",
        summaryDe: "Was Vanta gut kann, wo es für NIS 2 im Mittelstand nicht passt, und wann es trotzdem die richtige Wahl ist. Mit Quellen und Datum.",
        summaryEn: "What Vanta does well, where it does not fit NIS 2 in the mid-market, and when it is still the right choice. With sources and dates.",
        authorSlug: "simon-orzel",
        tags: ["regulation:nis2", "topic:comparison", "topic:open-source", "topic:vendors", "audience:ceo", "audience:ciso", "level:beginner"],
        subCategory: "Anbietervergleich",
        audience: ["ceo", "ciso"],
        relatedSlugs: ["drata-alternative", "grc-vergleich", "open-source-vs-us-saas"],
      },
      {
        slug: "drata-alternative",
        slugs: { de: "drata-alternative", en: "drata-alternative", nl: "drata-alternatief" },
        titleDe: "Drata-Alternative: NIS 2 aus dem Gesetz, nicht aus dem Kontrollkatalog",
        titleEn: "Drata alternative: NIS 2 from the law, not from a control catalog",
        summaryDe: "Drata bildet NIS 2 auf CIS Controls v8.1 ab. Was das leistet, was fehlt, und wann der Start beim Gesetz selbst der bessere Weg ist.",
        summaryEn: "Drata maps NIS 2 to CIS Controls v8.1. What that covers, what it misses, and when starting from the law itself is the better route.",
        authorSlug: "simon-orzel",
        tags: ["regulation:nis2", "topic:comparison", "topic:open-source", "topic:vendors", "audience:ceo", "audience:ciso", "level:beginner"],
        subCategory: "Anbietervergleich",
        audience: ["ceo", "ciso"],
        relatedSlugs: ["vanta-alternative", "grc-vergleich", "open-source-vs-us-saas"],
      },
      {
  ...
  "open-source": {
    slug: "open-source",
    slugs: CATEGORY_SLUGS["open-source"],
    titleDe: "Open Source und Souveränität",
    titleEn: "Open source and sovereignty",
    questionDe: "Warum offen, und was heißt das für meine Daten?",
    questionEn: "Why open, and what does that mean for my data?",
    entries: [
      {
        slug: "was-ist-nisd2",
        slugs: { de: "was-ist-nisd2", en: "what-is-nisd2", nl: "wat-is-nisd2" },
        titleDe: "Was nisd2.eu eigentlich ist",
        titleEn: "What nisd2.eu actually is",
        summaryDe: "Ein kostenloses, quelloffenes Pflichtenregister für NIS 2: Rechtsgrundlage je Anforderung, durchgehender Audit-Trail, kein Lock-in.",
        summaryEn: "A free, open-source obligation register for NIS 2: a legal basis per requirement, an end-to-end audit trail, no lock-in.",
        authorSlug: "simon-orzel",
        tags: ["regulation:nis2", "regulation:bsig", "topic:open-source", "topic:platform", "audience:ceo", "audience:ciso", "level:beginner"],
        subCategory: "Plattform",
        audience: ["ceo", "ciso"],
        relatedSlugs: ["open-source-vs-us-saas", "open-source-compliance", "nis2-fuer-management"],
      },
      {
        slug: "open-source-vs-us-saas",
        slugs: { de: "open-source-vs-us-saas", en: "open-source-vs-us-saas", nl: "open-source-vs-us-saas" },
        titleDe: "NIS-2-Software im Vergleich: US-SaaS gegen offene EU-Compliance",
        titleEn: "NIS 2 software: closed US SaaS versus open, EU-sovereign compliance",
        summaryDe: "Worauf es bei einem Werkzeug ankommt, mit dem Sie ein EU-Gesetz erfüllen: Nachvollziehbarkeit, Datensouveränität, kein Lock-in.",
        summaryEn: "What matters in a tool you use to meet an EU law: auditability, data sovereignty, no lock-in.",
        authorSlug: "simon-orzel",
        tags: ["regulation:nis2", "topic:open-source", "topic:sovereignty", "topic:comparison", "audience:ceo", "audience:ciso", "level:intermediate"],
        subCategory: "Souveränität",
        audience: ["ceo", "ciso"],
        relatedSlugs: ["was-ist-nisd2", "grc-vergleich", "open-source-compliance"],
      },
      {
        slug: "open-source-compliance",
        slugs: { de: "open-source-compliance", en: "open-source-compliance", nl: "open-source-compliance" },
        titleDe: "Open Source für Compliance: warum Prüfer ein offenes ISMS schätzen",
        titleEn: "Open source for compliance: why auditors value an open ISMS",
        summaryDe: "Ein offenes ISMS lässt sich überprüfen statt nur zusichern. Wie das die Pflichten zu Lieferkette, Schwachstellen und Wirksamkeit stützt.",
        summaryEn: "An open ISMS can be verified, not just assured. How that supports the duties on supply chain, vulnerabilities and effectiveness.",
        authorSlug: "cory-hisey",
        tags: ["regulation:nis2", "topic:open-source", "topic:auditability", "topic:supply-chain", "audience:ciso", "audience:auditor", "level:intermediate"],
        subCategory: "Souveränität",
        audience: ["ciso", "auditor"],
        relatedSlugs: ["was-ist-nisd2", "open-source-isms-nachteile", "open-source-vs-us-saas"],
      },
      {
        slug: "open-source-isms-nachteile",
        slugs: { de: "open-source-isms-nachteile", en: "open-source-isms-disadvantages", nl: "open-source-isms-nadelen" },
        titleDe: "Die ehrlichen Nachteile eines Open-Source-ISMS",
        titleEn: "The honest disadvantages of an open-source ISMS",
        summaryDe: "Betriebsaufwand, Support, Reifegrad und Verantwortung: die ehrliche Gegenrede zum eigenen Modell und unsere Antwort darauf.",
        summaryEn: "Operations burden, support, maturity and accountability: the honest case against our own model, and our answer.",
        authorSlug: "cory-hisey",
        tags: ["regulation:nis2", "topic:open-source", "topic:trust", "audience:ceo", "audience:ciso", "level:beginner"],
        subCategory: "Souveränität",
        audience: ["ceo", "ciso"],
        relatedSlugs: ["was-ist-nisd2", "open-source-compliance", "open-source-vs-us-saas"],
      },
    ],
  },
  "zeit-und-status": {
